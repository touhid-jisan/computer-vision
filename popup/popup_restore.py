...
class PopupText:
    ...
    def get_popup_text(self):
        while(True):
            ...
            img = cv2.imread('./images/1482.jpg')
            # img_copy = cv2.resize(img, None, fx=2, fy=2, interpolation=cv2.INTER_CUBIC)
